...
echo "The goal is to git clone /my-python-examples to /my-python-examples-updated"
...
echo "   /my-python-examples-updated (created in task-build-push.yml task file)"
echo " "
...
echo "git clone my-python-examples to my-python-examples-updated"
git clone my-python-examples my-python-examples-updated
echo " "

echo "cd my-python-examples-updated"
...
echo "    sed -i 's/svgs\//https:\/\/raw.githubusercontent.com\/JeffDeCola\/my-python-examples\/master\/svgs\//g' temp-README.md"
sed -i 's/svgs\//https:\/\/raw.githubusercontent.com\/JeffDeCola\/my-python-examples\/master\/svgs\//g' temp-README.md
echo " "
